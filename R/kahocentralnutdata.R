#' KAHO Anchialine Pools Central Group Nutrient Data
#'
#' This is the certified data set for KAHO central pool group for 2008-2017. This is an example of the correct format for nutrient data.
#' @format There are 20 variables but not all are necessary to run the graphing functions.
#' \describe{
...
#' \item{lab}{lab used to analyze samples}
...
#' \item{mean_value}{mean value for parameter}
