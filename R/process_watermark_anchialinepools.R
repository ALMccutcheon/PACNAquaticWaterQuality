#' Process and Watermark Anchialine Pool Animal photos
#'
#' Combines the gdb_table_wq and watermark_anchialinepools functions. Allowing for the user to select the park, location type, and month of sampling
#'
...
process_watermark_anchialinepools <-
function(gdb_name, gdb_location, gdb_layer,park,loctype,
  ...
  apply(X = t_select, MARGIN = 1, FUN = watermark_anchialinepools, new_folder = output_folder)
